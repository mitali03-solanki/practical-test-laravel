      ...
      <div class="row align-items-center mb-5">
        <div class="col-lg-7">
          <div class="intro-content" data-aos="fade-right" data-aos-delay="200">
            ...
            <p class="lead-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
            ...
            <div class="founder-highlight" data-aos="fade-up" data-aos-delay="300">
              <div class="founder-image">
                <img src="{{ asset('assets/img/person/person-m-7.webp') }}" alt="Founder" class="img-fluid">
              </div>
        ...
        <div class="col-lg-5">
          <div class="visual-section" data-aos="fade-left" data-aos-delay="250">
            <div class="main-image">
              <img src="{{ asset('assets/img/real-estate/property-exterior-7.webp') }}" alt="Luxury Development" class="img-fluid">
            ...
            <div class="overlay-image">
              <img src="{{ asset('assets/img/real-estate/property-interior-6.webp') }}" alt="Interior Design" class="img-fluid">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="team-preview" data-aos="fade-up" data-aos-delay="450">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
              ...
              <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="team-member" data-aos="flip-up" data-aos-delay="500">
                    <div class="member-image">
                      <img src="{{ asset('assets/img/real-estate/agent-5.webp') }}" alt="Team Member" class="img-fluid">
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="team-member" data-aos="flip-up" data-aos-delay="550">
                    <div class="member-image">
                      <img src="{{ asset('assets/img/real-estate/agent-2.webp') }}" alt="Team Member" class="img-fluid">
                    </div>
                    <div class="member-info">
                      <h5>David Chen</h5>
            ...
            <a href="#" class="view-team-btn">View Full Team</a>
          </div>
        </div>
